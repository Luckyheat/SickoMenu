...
void PunishEveryone::Process() {
	...
	const std::string resultMsg = isBan
		? std::format("<#ff033e><font=\"Barlow-Regular Outline\"><size=-0.24><b>Everyone Has Been Banned!</b></font></color>")
		: std::format("<#ff033e><font=\"Barlow-Regular Outline\"><size=-0.24><b>Everyone Has Been Kicked!</b></font></color>");
